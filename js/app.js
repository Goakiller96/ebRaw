(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hero__slider")) new core(".hero__slider", {
            ...
            navigation: {
                prevEl: ".hero__controls.swiper-button-prev",
                nextEl: ".hero__controls.swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".best__slider")) new core(".best__slider", {
            ...
            navigation: {
                prevEl: ".best__controls.swiper-button-prev",
                nextEl: ".best__controls.swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".voucher__slider")) new core(".voucher__slider", {
            modules: [ Navigation, Autoplay, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".review__slider")) new core(".review__slider", {
            ...
            navigation: {
                prevEl: ".review__controls.swiper-button-prev",
                nextEl: ".review__controls.swiper-button-next"
            }
        });
    }
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        const scrollItems = document.querySelectorAll(".promo__card, .social__image");
        const scrollAnimation = () => {
            let windowCenter = window.innerHeight / 1.3 + window.scrollY;
            scrollItems.forEach((el => {
                let scrollOffset = el.offsetTop + el.offsetHeight / 20;
                if (windowCenter >= scrollOffset) el.classList.add("animation"); else el.classList.remove("animation");
            }));
        };
        scrollAnimation();
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        const newYear = new Date("Nov 6 2023 00:00:00");
        ...
        const timeCount = () => {
            ...
            if (daysVal.textContent <= 10) daysVal.textContent = ("0" + days).slice(-2); else daysVal.textContent = days;
            if (hoursVal.textContent <= 10) hoursVal.textContent = ("0" + hours).slice(-2); else hoursVal.textContent = hours;
            if (minutesVal.textContent <= 10) minutesVal.textContent = ("0" + minutes).slice(-2); else minutesVal.textContent = minutes;
            if (secondsVal.textContent <= 10) secondsVal.textContent = ("0" + seconds).slice(-2); else secondsVal.textContent = seconds;
        };
        timeCount();
